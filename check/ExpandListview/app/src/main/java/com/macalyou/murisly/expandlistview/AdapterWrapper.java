package com.macalyou.murisly.expandlistview;
...
public class AdapterWrapper {
    ...
    private PinnedSectionListView.PinnedSectionListAdapter mPinnedAdapter;
    private PinnedSectionListView mPinnedListview;

    public AdapterWrapper(PinnedSectionListView pinnedlistview, Context context)
    {
        mPinnedListview = pinnedlistview;
        ListActivity listactive = (ListActivity)context;
        listactive.setListAdapter(new SimpleAdapter(context, android.R.layout.simple_list_item_1, android.R.id.text1));
    }
